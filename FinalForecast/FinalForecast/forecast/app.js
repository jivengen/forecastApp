            ...
            wsc.getLatLonForSelected = function(){
                GoogleGeolocationService.geoLocate(wsc.selected_city)
                    .then(function(res){
                        ...
                        //var google_static_maps_key = "AIzaSyDlvvtu5_XGwWk6dGUHbJgIF_q9CMqhi5M";
                        var google_static_maps_key = "AIzaSyDlvvtu5_XGwWk6dGUHbJgIF_q9CMqhi5M";
	...
	*/ 
    ...
    .factory('GoogleGeolocationService', ['$sce', '$http', 
        function($sce, $http){
            ...
            var key = "AIzaSyDlvvtu5_XGwWk6dGUHbJgIF_q9CMqhi5M";
    ...
    .factory('DarkSkyWeatherService',['$sce', '$http', 
        function($sce, $http){
            ...
            //DarkSky API key
            var key = "66eccea812b9c6b081e42e7b10e48c57";
